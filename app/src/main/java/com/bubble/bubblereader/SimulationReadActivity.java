...
import com.bubble.breader.widget.draw.helper.SimulationDrawHelper;

import java.io.File;

public class SimulationReadActivity extends AppCompatActivity {
    ...
    private void initRead() {
        ...
        mPageCreator = new BubblePageCreator.Builder(mReadView)
                ...
                .build();
        mReadView.setDrawHelper(new SimulationDrawHelper(mReadView));
